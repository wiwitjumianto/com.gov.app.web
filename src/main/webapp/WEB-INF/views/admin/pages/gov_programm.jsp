        ...
        <script type="text/javascript">
            ...
            var pageFunction = function () {
                ...
                otable = $('#datatable_fixed_column').DataTable({
                    ...
                    columns: [
                        ...
                        {"data": "govTrxProgrammSumUnit", "searchable": true},
                        {
                            ...
                            "render": function (data, type, full, meta) {
                                ...
                                return "<a style='cursor:pointer;' onclick='runProgramm(" + data.govTrxProgrammHeaderId + ")'>\n\
                                        <span class='fa fa-power-off'></span>&nbsp;&nbsp;Run Programm</a>&nbsp;&nbsp;&nbsp;\n\
                                        <a style='cursor:pointer;' onclick='editProgrammHeader(" + data.govTrxProgrammHeaderId + ")'>\n\
                                        <span class='fa fa-edit'></span>&nbsp;&nbsp;Edit</a>&nbsp;&nbsp;&nbsp;\n\
                                        <a style='cursor:pointer;' onclick='deleteProgrammHeader(" + data.govTrxProgrammHeaderId + ")'>\n\
                    ...
                    "autoWidth": true,
                    "oLanguage": {
                        "sInfoFiltered": "", "sInfo": "Menampilkan _START_ sampai _END_ dari _TOTAL_ entri",
            ...
            function addProgrammHeader() {
                window.location.href = "/gov/programm/header/modal2";
//                var json;
//                $.ajax({
//                    cache: false,
//                    type: "POST",
...
//                });
            ...
            function editProgrammHeader(govTrxProgrammHeaderId) {
                var data = {
                    "govTrxProgrammHeaderId": govTrxProgrammHeaderId
                };
                window.location.href = "/gov/programm/header/modal/" + govTrxProgrammHeaderId;
//                $.ajax({
//                    cache: false,
//                    type: "POST",
//                    url: "/gov/programm/header/modal",
...
//                });
            ...
            function runProgramm(govTrxProgrammHeaderId) {
                $.SmartMessageBox({
                    title: "Konfirmasi",
                    content: "Running Program Akan Menonaktifkan Program Lain Yang Sedang Berjalan \n\n\
                              Hanya Satu Program Yang Diizinkan. \n\
                              Apakah Anda Yakin Ingin Menjalankan Program?",
                    icon: "fa fa-thumbs-o-up",
                    buttons: '[Tidak][Ya]'
                }, function (ButtonPressed) {
                    if (ButtonPressed === "Ya") {
                        ...
                        $.ajax({
                            ...
                            'type': 'POST',
                            'url': '/gov/programm/header/saveOrUpdate/' + 4,
                            'data': JSON.stringify(data),
                            'dataType': 'json',
                            success: function (hasil) {
                                if (hasil.status) {
                                    $(".loading").hide();
                                    otable.ajax.reload(null, false);
                                    showSmallInfo("Informasi", "Programm Berhasil Dijalankan", 5000);
                                } else {
                                    $(".loading").hide();
                                    showSmallError("Kesalahan", "Programm Gagal Dijalanjakn", 5000);
                                }
                            }
                        });
                            ...
                            <div class="widget-body no-padding">
                                <table id="datatable_fixed_column"
                                    ...
                                    <tr>
                                        ...
                                        <th class="hasinput">
                                            <input type="text" class="form-control"
                                                   placeholder="Filter Nama Program Bantuan"/>
                                        </th>
                                        <th style="border-right: none !important;">
                                        </th>
                                        <th style="border-right: none !important;">
                                    ...
                                    <tr>
                                        ...
                                        <th width="8%">Jumlah Desa</th>
                                        <th width="10%">Total Bantuan Unit</th>
                                        <th width="5%">
