...
<div data-backdrop="static" class="modal fade in" id="modalGovProgrammHeader" role="dialog"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="govTrxProgrammHeaderName" id="govTrxProgrammHeaderName" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="govTrxProgrammHeaderStartDate"
                                           ...
                                           style="margin-top: 0px !important" data-dateformat="yyyy-mm-dd">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        <table id="datatableVillage"
                                            ...
                                            <c:forEach items="${programmDetail}" var="data2" varStatus="loop">
                                                <c:forEach items="${listVillage}" var="data">
