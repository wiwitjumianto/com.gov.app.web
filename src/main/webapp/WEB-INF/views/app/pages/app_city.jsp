        ...
        <script type="text/javascript">
            ...
            var pageFunction = function () {
                ...
                otable = $('#datatable_fixed_column').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: APP_PATH + "/app/city/datasource",
                        type: 'POST',
                        datatype: 'json',
                    ...
                    columns: [
                        ...
                        {"data": "status",
                            ...
                            "render": function (data, type, full, meta) {
                                ...
                                return "<a style='cursor:pointer;' onclick='editCity("+ data.appMstCityId + ")'>\n\
                                        <span class='fa fa-edit'></span>&nbsp;&nbsp;Edit</a>&nbsp;&nbsp;&nbsp;\n\
                                        <a style='cursor:pointer;' onclick='deleteCity("+ data.appMstCityId + ")'>\n\
                ...
                $(".datatablecrud").html('<table cellspacing="0" cellpadding="0" border="0" class="ui-pg-table navtable" style="float:left;table-layout:auto;"><tbody><tr>\n\
                                            <td class="ui-pg-button ui-corner-all" id="jqgridJobFunction_iladd" title="" data-original-title="Add new row"><div class="btn btn-sm btn-primary" onclick="addCity()"><span class="fa fa-plus"></span>&nbsp;Buat Kabupaten/Kota Baru</div>\n\
                                            </td>\n\
                                            </tr></tbody></table>');
            ...
            function editCity(appMstCityId) {
                var data = {
                    "appMstCityId": appMstCityId
                };
                $.ajax({
                    cache: false,
                    type: "POST",
            ...
            function deleteCity(appMstCityId) {
                $.SmartMessageBox({
                    title: "Konfirmasi",
                    ...
                    if (ButtonPressed === "Ya") {
                        ...
                        $.ajax({
                            ...
                            'type': 'POST',
                            'url': '/gov/app/city/saveOrUpdate/' + 3,
                            'data': JSON.stringify(data),
                            'dataType': 'json',
                    ...
                    <div class="jarviswidget jarviswidget-color-whitesmoke" id="wid-id-1" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-deletebutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                <table id="datatable_fixed_column" class="table table-striped table-bordered table-hover" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hasinput">
                                                <input type="text" class="form-control" placeholder="Filter Nama Province" />
                                            </th>
                                            <th class="hasinput">
                                                <input type="text" class="form-control" placeholder="Filter Nama Kota" />
                                            </th>
                                ...
                                <!--<button id ="addButton" class="btn btn-primary" onclick="addCity()"> Tambah Akun Baru</button>-->
                            </div>
                        </div>
                    </div>
                </article>
