        ...
        <script type="text/javascript">
            ...
            var pageFunction = function () {
                ...
                otable = $('#datatable_fixed_column').DataTable({
                    "processing": true,
                    "rowId": "appMstDistrictId",
                    "pagingType": "full_numbers",
                    "serverSide": true,
                    "ajax": {
                        url: APP_PATH + "/app/district/datasource",
                        type: 'POST',
                        datatype: 'json',
                    ...
                    columns: [
                        ...
                        {"data": "status",
                            ...
                            "render": function (data, type, full, meta) {
                                ...
                                return "<a style='cursor:pointer;' onclick='editDistrict("+ data.appMstDistrictId + ")'>\n\
                                        <span class='fa fa-edit'></span>&nbsp;&nbsp;Edit</a>&nbsp;&nbsp;&nbsp;\n\
                                        <a style='cursor:pointer;' onclick='deleteDistrict("+ data.appMstDistrictId + ")'>\n\
                ...
                $(".datatablecrud").html('<table cellspacing="0" cellpadding="0" border="0" class="ui-pg-table navtable" style="float:left;table-layout:auto;"><tbody><tr>\n\
                                            <td class="ui-pg-button ui-corner-all" id="jqgridJobFunction_iladd" title="" data-original-title="Add new row"><div class="btn btn-sm btn-primary" onclick="addDistrict()"><span class="fa fa-plus"></span>&nbsp;Buat Kecamatan Baru</div>\n\
                                            </td>\n\
                                            </tr></tbody></table>');
            ...
            function editDistrict(appMstDistrictId) {
                var data = {
                    "appMstDistrictId": appMstDistrictId
                };
                $.ajax({
                    cache: false,
                    type: "POST",
            ...
            function deleteDistrict(appMstDistrictId) {
                $.SmartMessageBox({
                    title: "Konfirmasi",
                    ...
                    if (ButtonPressed === "Ya") {
                        ...
                        $.ajax({
                            ...
                            'type': 'POST',
                            'url': '/gov/app/district/saveOrUpdate/' + 3,
                            'data': JSON.stringify(data),
                            'dataType': 'json',
                    ...
                    <div class="jarviswidget jarviswidget-color-whitesmoke" id="wid-id-1" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-deletebutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                <table id="datatable_fixed_column" class="table table-striped table-bordered table-hover" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="2" style="float: right">
                                ...
                                <!--<button id ="addButton" class="btn btn-primary" onclick="addDistrict()"> Tambah Akun Baru</button>-->
                            </div>
                        </div>
                    </div>
                </article>
