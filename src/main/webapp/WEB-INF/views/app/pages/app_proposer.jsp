        ...
        <script type="text/javascript">
            ...
            var pageFunction = function () {
                ...
                otable = $('#datatable_fixed_column').DataTable({
                    "processing": true,
                    "rowId": "appMstProposerId",
                    "pagingType": "full_numbers",
                    "serverSide": true,
                    "ajax": {
                        url: APP_PATH + "/app/proposer/datasource",
                        type: 'POST',
                        datatype: 'json',
                    ...
                    columns: [
                        {"data": null},
                        {"data": "appMstProposerName", "searchable": true},
                        {"data": "status",
                            "sortable": false,
                            "searchable": false,
                            ...
                            "render": function (data, type, full, meta) {
                                ...
                                return "<a style='cursor:pointer;' onclick='editProposer("+ data.appMstProposerId + ")'>\n\
                                        <span class='fa fa-edit'></span>&nbsp;&nbsp;Edit</a>&nbsp;&nbsp;&nbsp;\n\
                                        <a style='cursor:pointer;' onclick='deleteProposer("+ data.appMstProposerId + ")'>\n\
                    ...
                    "oLanguage": {"sInfoFiltered": "", "sInfo": "Menampilkan _START_ sampai _END_ dari _TOTAL_ entri",
                        "sEmptyTable": "Belum ada data Pengusul",
                ...
                $(".datatablecrud").html('<table cellspacing="0" cellpadding="0" border="0" class="ui-pg-table navtable" style="float:left;table-layout:auto;"><tbody><tr>\n\
                                            <td class="ui-pg-button ui-corner-all" id="jqgridJobFunction_iladd" title="" data-original-title="Add new row"><div class="btn btn-sm btn-primary" onclick="addProposer()"><span class="fa fa-plus"></span>&nbsp;Buat Instansi Pengusul Baru</div>\n\
                                            </td>\n\
                                            </tr></tbody></table>');
            ...
            function editProposer(appMstProposerId) {
                var data = {
                    "appMstProposerId": appMstProposerId
                };
            ...
            function deleteProposer(appMstProposerId) {
                $.SmartMessageBox({
                    title: "Konfirmasi",
                    ...
                    if (ButtonPressed === "Ya") {
                        ...
                        $.ajax({
                            ...
                            'type': 'POST',
                            'url': '/gov/app/proposer/saveOrUpdate/' + 3,
                            'data': JSON.stringify(data),
                            'dataType': 'json',
                                ...
                                <table id="datatable_fixed_column" class="table table-striped table-bordered table-hover" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hasinput">
                                                <input type="text" class="form-control" placeholder="Filter Nama Instansi Pengusul" />
                                            </th>
                                        ...
                                        <tr>
                                            <th width="2%">No.</th>
                                            <th data-class="expand">Nama Instansi Pengusul</th>
                                            <th width="5%"><center>Status</center></th>
                                            <th width="12%"><center>Aksi</center></th>
                                        </tr>
                                    </thead>
                                </table>
                                <!--<button id ="addButton" class="btn btn-primary" onclick="addProposer()"> Tambah Akun Baru</button>-->
                            </div>
                        </div>
                    </div>
                </article>
