        ...
        <script type="text/javascript">
            ...
            var pageFunction = function () {
                ...
                otable = $('#datatable_fixed_column').DataTable({
                    "processing": true,
                    "rowId": "appMstVillageId",
                    "pagingType": "full_numbers",
                    "serverSide": true,
                    "ajax": {
                        url: APP_PATH + "/app/village/datasource",
                        type: 'POST',
                        datatype: 'json',
                    ...
                    columns: [
                        {"data": null},
                        {"data": "appMstProvinceName", "searchable": true},
                        {"data": "appMstCityName", "searchable": true},
                        {"data": "appMstDistrictName", "searchable": true},
                        {"data": "appMstVillageName", "searchable": true},
                        {"data": "status",
                            "sortable": false,
                            "searchable": false,
                            ...
                            "render": function (data, type, full, meta) {
                                ...
                                return "<a style='cursor:pointer;' onclick='editVillage("+ data.appMstVillageId + ")'>\n\
                                        <span class='fa fa-edit'></span>&nbsp;&nbsp;Edit</a>&nbsp;&nbsp;&nbsp;\n\
                                        <a style='cursor:pointer;' onclick='deleteVillage("+ data.appMstVillageId + ")'>\n\
                ...
                $(".datatablecrud").html('<table cellspacing="0" cellpadding="0" border="0" class="ui-pg-table navtable" style="float:left;table-layout:auto;"><tbody><tr>\n\
                                            <td class="ui-pg-button ui-corner-all" id="jqgridJobFunction_iladd" title="" data-original-title="Add new row"><div class="btn btn-sm btn-primary" onclick="addVillage()"><span class="fa fa-plus"></span>&nbsp;Buat Desa/Kelurahan Baru</div>\n\
                                            </td>\n\
                                            </tr></tbody></table>');
            ...
            function editVillage(appMstVillageId) {
                var data = {
                    "appMstVillageId": appMstVillageId
                };
                $.ajax({
                    cache: false,
                    type: "POST",
            ...
            function deleteVillage(appMstVillageId) {
                $.SmartMessageBox({
                    title: "Konfirmasi",
                    ...
                    if (ButtonPressed === "Ya") {
                        ...
                        $.ajax({
                            ...
                            'type': 'POST',
                            'url': '/gov/app/village/saveOrUpdate/' + 3,
                            'data': JSON.stringify(data),
                            'dataType': 'json',
                    ...
                    <div class="jarviswidget jarviswidget-color-whitesmoke" id="wid-id-1" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-deletebutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                <table id="datatable_fixed_column" class="table table-striped table-bordered table-hover" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hasinput">
                                                <input type="text" class="form-control" placeholder="Filter Nama Provinsi" />
                                            </th>
                                            <th class="hasinput">
                                                <input type="text" class="form-control" placeholder="Filter Nama Kota/Kabupaten" />
                                            </th>
                                            <th class="hasinput">
                                                <input type="text" class="form-control" placeholder="Filter Nama Kecamatan" />
                                            </th>
                                            <th class="hasinput">
                                                <input type="text" class="form-control" placeholder="Filter Nama Desa/Kelurahan" />
                                            </th>
                                        <tr>
                                            <th width="2%">No.</th>
                                            <th data-class="expand">Nama Provinsi</th>
                                            <th data-class="expand">Nama Kota/Kabupaten</th>
                                ...
                                <!--<button id ="addButton" class="btn btn-primary" onclick="addVillage()"> Tambah Akun Baru</button>-->
                            </div>
                        </div>
                    </div>
                </article>
