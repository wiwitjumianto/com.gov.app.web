! function(t, e, a, n) {
    function s(a, s) {
        function i(e) {
            e && e.length > 1 && (t(s.sidebar, u).children("li").children("a[href='" + e + "']").parent("li").addClass(s.activeClass), t(s.sidebar, u).children("li").children("a[href!='" + e + "']").parent("li").removeClass(s.activeClass))
        }
        ...
        function o() {
            if (s.addButtons)
                for (var a = t("<div/>", {
                        ...
                        onclick: s.nextType,
                        text: s.nextType
                    })), o = t(".panel-collapse .panel-body ", u), c = o.length, r = 0; c > r; r++) 0 === r ? t(o[0]).append(a) : r === c - 1 ? t(o[c - 1]).append(l) : t(o[r]).append(t(n).clone());
            s.autoScrolling && (d = e.location.hash), d = d || t(s.sidebar, u).children("li." + s.todoClass + ":first").children("a").attr("href") || t(s.sidebar, u).children("li:first").children("a").attr("href"), s.autoScrolling && (e.location.hash = d);
            var h = "#" + t(".panel-group", u)[0].id;
            t(".collapse", u).each(function() {
                t(this).collapse("#" + this.id === d ? t(this).hasClass("in") ? {
                    parent: h,
                    toggle: !1
                } : {
                    parent: h,
            ...
            }), i(d), s.autoScrolling && t(e).bind("hashchange", function() {
            ...
            }), s.addButtons && (t("." + s.stepClass, u).children("button[type='" + s.nextType + "']").click(function(a) {
                a.preventDefault();
                var n = t(this).parents(".panel-collapse")[0];
                if (p("beforeNext", n) === !1) return !1;
                var s = "#" + t(".panel-collapse", t(n).parents(".panel").next(".panel")[0])[0].id;
                t(s).collapse("show"), p("onNext", n), d = s, i(d), e.location.hash = d
            }), t("." + s.stepClass, u).children("button[type='" + s.backType + "']").click(function(a) {
                a.preventDefault();
                var n = t(this).parents(".panel-collapse")[0];
                if (p("beforeBack", n) === !1) return !1;
        ...
        var d, h = a,
            u = t(a);
        return s = t.extend({}, t.fn[l].defaults, s), o(), {
            option: c,
            destroy: r
        }
    }
