        ...
        <script type="text/javascript">
            ...
            var pageFunction = function () {
                ...
                otable = $('#datatable_fixed_column').DataTable({
                    "processing": true,
                    "rowId": "appMstProvinceId",
                    "pagingType": "full_numbers",
                    "serverSide": true,
                    "ajax": {
                        url: APP_PATH + "/app/province/datasource",
                        type: 'POST',
                        datatype: 'json',
                    ...
                    columns: [
                        ...
                        {"data": "status",
                            ...
                            "render": function (data, type, full, meta) {
                                ...
                                return "<a style='cursor:pointer;' onclick='editProvince("+ data.appMstProvinceId + ")'>\n\
                                        <span class='fa fa-edit'></span>&nbsp;&nbsp;Edit</a>&nbsp;&nbsp;&nbsp;\n\
                                        <a style='cursor:pointer;' onclick='deleteProvince("+ data.appMstProvinceId + ")'>\n\
                ...
                $(".datatablecrud").html('<table cellspacing="0" cellpadding="0" border="0" class="ui-pg-table navtable" style="float:left;table-layout:auto;"><tbody><tr>\n\
                                            <td class="ui-pg-button ui-corner-all" id="jqgridJobFunction_iladd" title="" data-original-title="Add new row"><div class="btn btn-sm btn-primary" onclick="addProvince()"><span class="fa fa-plus"></span>&nbsp;Buat Provinsi Baru</div>\n\
                                            </td>\n\
                                            </tr></tbody></table>');
            ...
            function editProvince(appMstProvinceId) {
                var data = {
                    "appMstProvinceId": appMstProvinceId
                };
            ...
            function deleteProvince(appMstProvinceId) {
                $.SmartMessageBox({
                    title: "Konfirmasi",
                    ...
                    if (ButtonPressed === "Ya") {
                        ...
                        $.ajax({
                            ...
                            'type': 'POST',
                            'url': '/gov/app/province/saveOrUpdate/' + 3,
                            'data': JSON.stringify(data),
                            'dataType': 'json',
                    ...
                    <div class="jarviswidget jarviswidget-color-whitesmoke" id="wid-id-1" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-deletebutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <!--<button id ="addButton" class="btn btn-primary" onclick="addProvince()"> Tambah Akun Baru</button>-->
                            </div>
                        </div>
                    </div>
                </article>
