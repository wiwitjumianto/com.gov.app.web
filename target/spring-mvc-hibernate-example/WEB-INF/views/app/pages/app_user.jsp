        ...
        <script type="text/javascript">
            ...
            var pageFunction = function () {
                ...
                otable = $('#datatable_fixed_column').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: APP_PATH + "/app/configuring/user/datasource",
                        type: 'POST',
                        datatype: 'json',
                    ...
                    columns: [
                        {"data": null},
                        {"data": "appMstUserName", "searchable": true},
                        {"data": "appMstUserPassword", "searchable": true},
                        {"data": "appMstUserRoleId",
                            "sortable": false,
                            "searchable": false,
                        ...
                        {"data": "status",
                            ...
                            "render": function (data, type, full, meta) {
                                ...
                                return "<a style='cursor:pointer;' onclick='editUser("+ data.appMstUserId + ")'>\n\
                                        <span class='fa fa-edit'></span>&nbsp;&nbsp;Edit</a>&nbsp;&nbsp;&nbsp;\n\
                                        <a style='cursor:pointer;' onclick='deleteUser("+ data.appMstUserId + ")'>\n\
                ...
                $(".datatablecrud").html('<table cellspacing="0" cellpadding="0" border="0" class="ui-pg-table navtable" style="float:left;table-layout:auto;"><tbody><tr>\n\
                                            <td class="ui-pg-button ui-corner-all" id="jqgridJobFunction_iladd" title="" data-original-title="Add new row"><div class="btn btn-sm btn-primary" onclick="addUser()"><span class="fa fa-plus"></span>&nbsp;Buat Akun Baru</div>\n\
                                            </td>\n\
                                            </tr></tbody></table>');
            ...
            function editUser(appMstUserId) {
                var data = {
                    "appMstUserId": appMstUserId
                };
                $.ajax({
                    cache: false,
                    type: "POST",
            ...
            function deleteUser(appMstUserId) {
                $.SmartMessageBox({
                    title: "Konfirmasi",
                    ...
                    <div class="jarviswidget jarviswidget-color-whitesmoke" id="wid-id-1" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-deletebutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                <table id="datatable_fixed_column" class="table table-striped table-bordered table-hover" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hasinput">
                                                <input type="text" class="form-control" placeholder="Filter Nama Akun" />
                                            </th>
                                        ...
                                        <tr>
                                            <th width="2%">No.</th>
                                            <th data-class="expand">Nama Akun</th>
                                            <th data-hide="phone, tablet">Password</th>
                                            <th width="8%"><center>Is Admin</center></th>
                                ...
                                <!--<button id ="addButton" class="btn btn-primary" onclick="addUser()"> Tambah Akun Baru</button>-->
                            </div>
                        </div>
                    </div>
                </article>
