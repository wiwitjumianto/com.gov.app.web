...
<div data-backdrop="static" class="modal fade in" id="modalAppVillage" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control sel2" onchange="getCity(this.value)" style="width:100%;" id="appMstProvinceId" name="appMstProvinceId">
                                    ...
                                    <c:forEach items="${listProvince}" var="data">
                                        <option  <c:if test="${data.appMstProvinceId == listVillage.appMstProvinceId}">selected</c:if> value="${data.appMstProvinceId}">${data.appMstProvinceName}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control sel2" onchange="getDistrict(this.value)" style="width:100%;" id="appMstCityId" name="appMstCityId">
                                    ...
                                    <c:forEach items="${listCity}" var="datac">
                                        <option  <c:if test="${datac.appMstCityId == listVillage.appMstCityId}">selected</c:if> value="${datac.appMstCityId}">${datac.appMstCityName}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control sel2" style="width:100%;" id="appMstDistrictId" name="appMstDistrictId">
                                    <option value=""> -- Pilih Kota/Kab -- </option>
                                    <c:forEach items="${listDistrict}" var="datac">
                                        <option  <c:if test="${datac.appMstDistrictId == listVillage.appMstDistrictId}">selected</c:if> value="${datac.appMstDistrictId}">${datac.appMstDistrictName}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input name="appMstVillageName" id="appMstVillageName" type="text"  class=" form-control" placeholder="" value="${listVillage.appMstVillageName}">
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function validate() {
            $('#modalAppVillage').bootstrapValidator('validate');
        }
        ...
        function submit() {
            var data = $("#formVillage").serializeJSON();
            var dataString = JSON.stringify(data);
            var idData = $("#appMstVillageId").val();
            var is = null;
            if (idData === "") {
                is = 1;
            } else {
            ...
            $.ajax({
                ...
                'type': 'POST',
                'url': '/gov/app/village/saveOrUpdate/' + is,
                'data': dataString,
                'dataType': 'json',
